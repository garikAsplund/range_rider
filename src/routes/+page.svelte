...
>
	<!-- Order now! -->
	<button class="p-4 border-red-500 border rounded-sm hover:opacity-85 {isOpen ? '' : 'hidden'}"
		><a href="https://www.toasttab.com/range-rider-107-northwest-1st-street/v3">Order now!</a
		></button
	><!-- Menu -->
	<button class="p-4 hover:opacity-85"><a href="/menu">Menu</a></button>
	<!-- Music -->
	<button class="p-4 hover:opacity-85"><a href="/music">Music</a></button>
